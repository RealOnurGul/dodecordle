    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 bg-gray-900">
      <div className="w-full max-w-md">
        ...
        <div className="mb-12 text-center">
          ...
          <Link
            href="/how-to-play"
            className="inline-block mt-4 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-700 hover:bg-gray-600 text-white flex items-center justify-center text-lg sm:text-xl font-bold transition-colors shadow-md hover:shadow-lg mx-auto"
