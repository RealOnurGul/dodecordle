...
export default function GameBoard() {
  ...
  return (
    <>
      {/* Mobile: Full width grid with margins */}
      <div className="w-full flex justify-center px-2 sm:hidden">
      ...
      <div className="hidden sm:flex w-full justify-center">
        <div className="grid grid-cols-2 gap-3 md:gap-4" style={{ width: 'calc(50% + 0.5rem)', maxWidth: '100%' }}>
          {state.targetWords.map((targetWord, index) => (
            <div
              key={index}
              className={`
